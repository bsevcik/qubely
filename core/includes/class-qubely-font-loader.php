 ...
 * @since 1.6.0
 */
class Qubely_Font_Loader {


	/**
	 * This plugin's instance.
	 *
	 * @var Qubely_Font_Loader
	 */
	 ...
	 *
	 * @return Qubely_Font_Loader
	 */
	public static function register() {
		if ( null === self::$instance ) {
			self::$instance = new Qubely_Font_Loader();
		}
		...
		if ( $post && isset( $post->ID ) ) {
			...
			if ( ! empty( $fonts ) ) {
				...
				if ( ! empty( $gfonts ) ) {
					...
					wp_enqueue_style( 'qubely_google_fonts' );
				}
